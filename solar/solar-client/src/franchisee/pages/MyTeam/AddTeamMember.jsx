    ...
    if (success) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] bg-white rounded-xl shadow-sm p-8 text-center">
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-2">Team Member Added!</h2>
                <p className="text-gray-600">The new team member has been successfully created and added to the system.</p>
                <p className="text-sm text-gray-500 mt-4">Redirecting to team list...</p>
            </div>
        );
    }
    ...
    return (
        <div className="container mx-auto px-4 py-6 max-w-4xl">
            ...
            <div className="flex items-center mb-6">
                <button
                    onClick={() => navigate('/franchisee/my-team')}
                    className="mr-4 p-2 hover:bg-gray-100 rounded-full transition-colors"
                >
                    <ArrowLeft size={24} className="text-gray-600" />
                </button>
                <h1 className="text-2xl font-bold text-gray-800">Add New Team Member</h1>
            </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="p-8">
                    ...
                    {/* Permissions Section */}
                    <div className="space-y-4">
                        <h2 className="text-lg font-semibold text-blue-600">User Permissions</h2>
                        <p className="text-sm text-gray-500 mb-4">Select the modules this team member can access</p>

                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            {Object.keys(formData.permissions).map((permission) => (
                                <label key={permission} className="flex items-center p-4 border rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                                    <input
                                        type="checkbox"
