...
const CreateLeadPartnerForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        setTimeout(() => {
            ...
            setSuccess(true);
            setTimeout(() => {
                navigate('/franchisee/lead-partner/create');
            }, 2000);
        }, 1500);
    };
    ...
    if (success) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] bg-white rounded-xl shadow-sm p-8 text-center">
                ...
                <p className="text-gray-600">The new lead partner has been successfully created and added to your network.</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <Activity size={18} className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
                                    <select
                                        name="projectType"
                                        required
                                        className="w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition-all"
